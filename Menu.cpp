...
void Menu::menu(sf::RenderWindow& window, sf::Font& font) {

	sf::Text* menuStartGame = new sf::Text(utf2cp("Начать игру"), font, 30);
	sf::Text* menuAbout = new sf::Text(utf2cp("Об Игре"), font, 30);
	sf::Text* menuExit = new sf::Text(utf2cp("Выход"), font, 30);
